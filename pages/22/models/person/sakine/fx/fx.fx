...
#define ToonPower	0.42			// 影の暗さ
#define OverBright	1.02		// 白飛びする危険性をおかして明るくする。

// ソフトシャドウ 補正係数
#define SOFTSHADOW_DISTANCE 0.001	// ソフトシャドウを打ち切る距離(小さいほど遠い)
#define SOFTSHADOW_THRESHOLD 0.0032 // ソフトシャドウ補正値 大きいほど影が薄い
...
float4 BufferShadow_PS(BufferShadow_OUTPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon) : COLOR
{
    ...
    comp*= (comp>=0) ? shadow*ShadowDarkness+1.0-ShadowDarkness : ShadowDarkness -5.25;
	Color = lerp(ShadowColor, Color, comp);

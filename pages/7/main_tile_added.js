...
function redrawAll() {
    ...
    for (const obj of objects) {
        ...
        if (obj.htmlElement) {
            ...
            if(obj.name=="cat"){
            obj.htmlElement.style.left = `${(x - (w / 2))-10}px`;
            obj.htmlElement.style.top = `${(y - (h / 2))-4}px`;
            }else{
            obj.htmlElement.style.left = `${(x - (w / 2)+5)}px`;
            obj.htmlElement.style.top = `${(y - (h / 2))+2}px`;
...
function drawObjects() {
    ...
    addBox({
        ...
        color: "#00f",
        stat: true,
        htmlElement:criarImagem("block_black.png")      
    });
    ...
    addBox({
        ...
        mass: 4,
        stat: false,  
        htmlElement:criarImagem("block_gray.png")      
    });
}

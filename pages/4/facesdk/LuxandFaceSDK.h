...
//
//
//  Copyright(c) 2005-2022 Luxand, Inc.
//         http://www.luxand.com
//
///////////////////////////////////////////////////
...
#define FSDKE_TENSORFLOW_NOT_INITIALIZED        -29
...
int _FSDKIMPORT_ FSDK_SetParameters(const char* Parameters, int* ErrorPosition);
int _FSDKIMPORT_ FSDK_SetParameter(const char* parameter, const char* value);

...
class IPHYSICS {
    ...
    async createObj(
        obj,
        type,//box|cylinder|sphere|hull|mesh|triangle
        model,//obj - tile - wall
        tam, //vector3 size | null
        mass, //0=static
        contactS,//extra contact size | null
        ...
        switch (type) {
            case 'box':
                meshmodel = new THREE.BoxGeometry(tam.x, tam.y, tam.z, 4, 4, 4);

...
import { Vector3, Quaternion, Matrix4, AnimationMixer, VectorKeyframeTrack, QuaternionKeyframeTrack, AnimationClip, SkeletonHelper, Vector2, Euler } 
from 'three'
...
if (!boneParent || !boneToParent) continue;
...
export { clone, findBoneTrackData, getBoneByName, getBones, getEqualsBonesNames, getHelperFromSkeleton, getNearestBone, getSkeletonOffsets, renameBones, retarget, retargetClip };